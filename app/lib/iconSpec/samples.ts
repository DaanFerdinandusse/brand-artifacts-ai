...
export const sampleIcons: IconSpec[] = [
  {
    docType: "icon",
    name: "home",
...
export function getSampleIcon(name: string): IconSpec | undefined {
  return sampleIcons.find((icon) => icon.name === name);
}

export function getSampleIconByIndex(index: number): IconSpec {
